...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(spinner, http, router) {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.messs = false;
        // this.spinner.show();
        this.http.get('http://jsonplaceholder.typicode.com/photos').subscribe(function (res) {
            _this.photos = res;
            // this.spinner.hide();
        }, function (error) { _this.messs = true; } // error path
        );
    ...
    HomeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [ngx_spinner__WEBPACK_IMPORTED_MODULE_1__["NgxSpinnerService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], HomeComponent);
